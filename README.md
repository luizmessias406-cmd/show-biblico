...
<head>
    ...
    <title>Show do Milhão Bíblico - Oficial</title>
    <style>
...
<body>
    ...
    <script>
        ...
        const deckA = [
            ...
            { q: "Qual foi o mar que se abriu para o povo de Israel passar?", o: ["Mar Morto", "Mar Vermelho", "Mar da Galileia", "Mar Negro"], c: 1 },
            ...
            { q: "Qual o nome do rei da Babilônia que destruiu Jerusalém?", o: ["Ciro", "Nabucodonosor", "Dário", "Artaxerxes"], c: 1 },
            ...
            { q: "Em qual cidade Paulo estava quando teve a visão do homem macedônio?", o: ["Atenas", "Trôade", "Éfeso", "Corinto"], c: 1 },
            { q: "Qual o nome do sacerdote que ajudou Joás a se tornar rei criança?", o: ["Elias", "Joiada", "Zacarias", "Abiatar"], c: 1 },
        ...
        const deckB = [
            ...
            { q: "Qual profeta confrontou o rei Davi após o pecado com Bate-Seba?", o: ["Samuel", "Natã", "Elias", "Eliseu"], c: 1 },
            ...
            { q: "Qual livro vem logo depois de Atos dos Apóstolos?", o: ["Gálatas", "Romanos", "Coríntios", "Hebreus"], c: 1 },
            { q: "Qual rainha visitou Salomão para provar sua sabedoria?", o: ["Rainha de Sabá", "Ester", "Jezabel", "Vasti"], c: 0 },
            { q: "Quem mandou jogar Sadraque, Mesaque e Abede-Nego na fornalha?", o: ["Dário", "Nabucodonosor", "Belsazar", "Herodes"], c: 1 },
            ...
            { q: "Qual rei tentou matar Jesus quando Ele ainda era criança?", o: ["Pilatos", "Herodes", "Agripa", "César"], c: 1 },
            ...
            { q: "Qual juiz de Israel fez um voto precipitado envolvendo sua filha?", o: ["Gideão", "Jefté", "Sansão", "Samuel"], c: 1 },
            { q: "Em qual livro da Bíblia não aparece a palavra 'Deus'?", o: ["Rute", "Ester", "Cantares", "Eclesiastes"], c: 1 },
        ...
        function iniciarJogo() {
            // Sorteia um dos dois decks completos
            perguntasAtuais = Math.random() < 0.5 ? deckA : deckB;
            etapa = 0;
            pulos = 3;
        ...
        function carregarPergunta() {
            if (etapa >= 26) {
                alert("INCRÍVEL! VOCÊ CHEGOU AO MILHÃO!");
                iniciarJogo();
                return;
            }
            
            pAtual = perguntasAtuais[etapa]; // Pega exatamente a pergunta da posição da etapa
        ...
        function verificar(escolha) {
            if (escolha === pAtual.c) {
                ...
                alert("VOCÊ ERROU! A resposta era: " + pAtual.o[pAtual.c] + "\nReiniciando com novas perguntas...");
                iniciarJogo();
            }
        }
        ...
        function pular() {
            if (pulos > 0) {
                ...
                etapa++; // Passa para a próxima pergunta da lista fixa
                carregarPergunta();
        ...
        function ajudaCartas() {
            ...
            alert("Cartas: " + (eliminadas == 0 ? "Rei (Nada acontece)" : "Eliminando " + eliminadas + " errada(s)"));
            let removidas = 0;
            for(let i=0; i<4; i++) {
        ...
        function ajudaUniv() {
            alert("Os Universitários acham que é: " + pAtual.o[pAtual.c]);
